          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flelx flex-col">
              <div className="flex justify-between">
                ...
                <Button disabled={user._id === product.seller._id} onClick={()=> setShowBids(!showBids)} >New Bid</Button>
              </div>
               {showBids && (<BidModel product={product} reloadData={getData}  showBid={showBids} setShowBids={setShowBids} />)}
            </div>
